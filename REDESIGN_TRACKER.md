...
- Pass 4: Premium industry imagery. Scope: replace low-resolution mixed industry photos with a cohesive generated 1600x1200 editorial set while preserving the old source assets. Status: implemented locally and verified on homepage and industries layouts; deploy pending.
